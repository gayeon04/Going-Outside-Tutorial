...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Settings|Als Character Example", Meta = (DisplayThumbnail = false))
	TObjectPtr<UInputAction> StickMove_Left_Step1_Action;
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Settings|Als Character Example", Meta = (DisplayThumbnail = false))
	TObjectPtr<UInputAction> StickMove_Left_Step2_Action;
...
protected:
	...
	void Input_OnMove_Internal(const FVector2d& MoveVector);
...
public:
	...
	//@KURT - for stick movement
protected:
	virtual void Input_StickMovement_Left_Step1(const FInputActionValue& ActionValue) {}
	virtual void Input_StickMovement_Left_Step2(const FInputActionValue& ActionValue) {}
