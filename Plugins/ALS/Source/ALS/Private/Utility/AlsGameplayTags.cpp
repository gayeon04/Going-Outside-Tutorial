...
namespace AlsOverlayModeTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Stick, FName{TEXTVIEW("Als.OverlayMode.Stick")})
}
...
namespace AlsStickMovementTags
{
	UE_DEFINE_GAMEPLAY_TAG(Default, FName{TEXTVIEW("Hiking.StickMovement.Default")})
	UE_DEFINE_GAMEPLAY_TAG(Left_Step1_Succeeded, FName{TEXTVIEW("Hiking.StickMovement.Left.Step1.Succeeded")})
	UE_DEFINE_GAMEPLAY_TAG(Left_Step1_Failed, FName{TEXTVIEW("Hiking.StickMovement.Left.Step1.Failed")})
	UE_DEFINE_GAMEPLAY_TAG(Left_Step2_Succeeded, FName{TEXTVIEW("Hiking.StickMovement.Left.Step2.Succeeded")})
	UE_DEFINE_GAMEPLAY_TAG(Left_Step2_Failed, FName{TEXTVIEW("Hiking.StickMovement.Left.Step2.Failed")})

	UE_DEFINE_GAMEPLAY_TAG(Right_Step1_Succeeded, FName{TEXTVIEW("Hiking.StickMovement.Right.Step1.Succeeded")})
	UE_DEFINE_GAMEPLAY_TAG(Right_Step1_Failed, FName{TEXTVIEW("Hiking.StickMovement.Right.Step1.Failed")})
	UE_DEFINE_GAMEPLAY_TAG(Right_Step2_Succeeded, FName{TEXTVIEW("Hiking.StickMovement.Right.Step2.Succeeded")})
	UE_DEFINE_GAMEPLAY_TAG(Right_Step2_Failed, FName{TEXTVIEW("Hiking.StickMovement.Right.Step2.Failed")})
