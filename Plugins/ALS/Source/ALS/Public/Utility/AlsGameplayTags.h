...
namespace AlsOverlayModeTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stick)
}
...
namespace AlsStickMovementTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Left_Step1_Succeeded)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Left_Step1_Failed)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Left_Step2_Succeeded)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Left_Step2_Failed)
	
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Right_Step1_Succeeded)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Right_Step1_Failed)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Right_Step2_Succeeded)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Right_Step2_Failed)
}
