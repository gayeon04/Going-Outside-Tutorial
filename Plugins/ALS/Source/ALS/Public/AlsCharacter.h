...
public:
	...
	FGameplayTag GetStickMovementTag() const {return StickMovementTag;}
...
private:
	...
	//@@Hiking - for update anim sequence in sepaate anim instace
public:
	UFUNCTION(BlueprintCallable, Category = "ALS|Character")
	void SetAnimActionTag (const FGameplayTag InAnimActionTag);
	
	UFUNCTION(BlueprintCallable, Category = "ALS|Character")
	FGameplayTag GetAnimActionTag () const { return AnimActionTag;}
	
protected:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS|Character")
	FGameplayTag AnimActionTag = FGameplayTag::EmptyTag;
